    ...
    if (nome != "") {
      if (descricao != "") {
        if (preco != "") {
          ...
          setAlertMensagem("O campo preço é obrigatório");
        } 
      ...
      setAlertClass("mb-3 mt-2");
      setAlertMensagem("O campo descrição é obrigatório");
...
return (
  <div>
    ...
    <Container>
      ...
      <form className="mt-3" onSubmit={handleSubmite}>
        <Row>
          <Col xs={6}>
            {/* Caixinha de nome */}
            <FloatingLabel
